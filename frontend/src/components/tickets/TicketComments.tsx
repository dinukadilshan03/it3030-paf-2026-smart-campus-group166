    ...
    <section className="rounded-[1.5rem] border border-white/70 bg-white/85 p-6 shadow-[0_18px_55px_rgba(15,23,42,0.08)] backdrop-blur">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm leading-7 text-slate-600">
            Public replies are visible to the reporter and staff. Internal notes stay inside the
            operational queue.
          </p>
        </div>
      </div>
      ...
      <form
        ...
        onSubmit={async (event) => {
          ...
          const validationErrors = validateCommentForm(
            values,
      ...
      >
        ...
        >
          {busy ? "Posting..." : values.commentType === "INTERNAL_NOTE" ? "Add internal note" : "Post reply"}
        </button>
      </form>
